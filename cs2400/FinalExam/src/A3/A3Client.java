package A3;
/**
   A driver that demonstrates the class DoublyLinkedWithDummyNodeDeque.
...
public class A3Client 
{
	...
	public static void testDequeOperations()
	{
		...
		DequeInterface<String> myDeque = new DequeWithDummyNode<>();
      ...
      System.out.println("The next call will throw an exception." + "\n");
		front = myDeque.removeFront();
...
/*
 ...
 at DoublyLinkedWithDummyNodeDeque.removeFront(DoublyLinkedWithDummyNodeDeque.java:74)
