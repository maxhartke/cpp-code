package question7.superclass;
public class CommunityMember{
   private static int counter=10000;//static variable
   protected String ID; // ID is kept public for illustrating the inheritance of public members
   private String name;
   private int age;   
...
/*    public CommunityMember(){//default constructor
   ...
   public CommunityMember(String name, int age, float salary){//non-default contructor
	   ...
	   this.age=age;
	   this.salary=salary;
	   this.ID="" + CommunityMember.counter;
	   CommunityMember.counter++;
   }
   //accessor for name
