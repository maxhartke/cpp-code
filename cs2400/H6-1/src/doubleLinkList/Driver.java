...
public class Driver
{
	...
	{
		ListInterface<String> myList = new DLList<>();
...
*/
      ...
      System.out.println();
		...
		System.out.println("Add more entries to end: Add 23, 89, 18, 36");
		myList.add("23");
		myList.add("89");
		myList.add("18");
		myList.add("36");
		System.out.println("List should contain \n92 93 52 53 50 23 89 18 36");
		displayList(myList);
		System.out.println("Testing sortItems()");
		System.out.println("List should contain \n18 23 36 50 52 53 89 92 93");
		myList.sortItems();
		displayList(myList);
   } // end testStringList
