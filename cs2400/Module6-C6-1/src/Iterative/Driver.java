   ...
   private static final Integer [] nos = new Integer[25];
	...
	public static void main(String[] args)
	{
		...
		for (int count = 11; count > 0; count = count - 5)
		{
			...
			testSort(2, true, "insertion sort", count);
		} // end for
		...
		{
			System.out.println(count + " items in array.");			
			testSortLexi(1, true, "selection sort", count);
			testSortLexi(2, true, "insertion sort", count);
		} // end for
	}  // end main
	public static void testSort(int sort, boolean print, String name, int n)
	{
		...
		switch (sort)
		{
         case 1: SelectionSort.selectionSort(array, n); break;
         case 2: InsertionSort.insertionSort(array, n); break;
